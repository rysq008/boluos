...
import com.delevin.boluolcs.adapter.ChongzhiJiluAdapter;
...
public class ChongzhiJiluActivity extends BaseActivity {
	...
	private void getDatas() {
		...
		Myapplication.okhttpManger.sendComplexForm(
				this,
				false,
				QntUtils.getURL(BeanUrl.ChongzhiJilu, BoluoUtils
						.getShareOneData(getApplicationContext(), "phone"))
					...
					public void onResponse(JSONObject jsonObject) {
						try {
							...
							index += 1;
							adapter = new ChongzhiJiluAdapter(
