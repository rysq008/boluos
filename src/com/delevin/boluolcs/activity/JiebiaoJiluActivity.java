...
import com.delevin.boluolcs.adapter.JiebiaoJiluAdapter;
...
public class JiebiaoJiluActivity extends BaseActivity implements
		OnItemClickListener {
...
//				});
		...
		Myapplication.okhttpManger.sendComplexForm(this,false,QntUtils.getURL(BeanUrl.TOUZI_MINGXI_STRING, BoluoUtils.getShareOneData(getApplicationContext(), "phone"))+ index+"?index=2", null, new Funck4() {
					...
					public void onResponse(JSONObject jsonObject) {
						try {
							...
							index += 1;
							adapter = new JiebiaoJiluAdapter(getApplicationContext(),
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		Intent intent = new Intent(JiebiaoJiluActivity.this,
