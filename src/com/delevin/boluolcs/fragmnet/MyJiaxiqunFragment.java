...
import com.delevin.boluolcs.adapter.MyJiaxiquanAdapter;
...
public class MyJiaxiqunFragment extends Fragment {
	...
	private MyJiaxiquanAdapter adapter;
					...
					public void onResponse(JSONObject jsonObject) {
						try {
							...
							if (datas.size() == 0)
								rlNotData.setVisibility(View.VISIBLE);
							// index += 1;
							adapter = new MyJiaxiquanAdapter(getActivity(),
									datas, R.layout.item_jiaxiquan);
							adapter.notifyDataSetChanged();
